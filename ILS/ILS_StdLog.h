...
protected:
	...
	mutable std::shared_ptr<std::ostream> p_log_out, p_wrn_out, p_err_out;
...
public: // Конструктор
	...
	StdLogger(std::ostream& l_out = std::cout, std::ostream& w_out = std::cerr, std::ostream& e_out = std::cerr);
	...
	StdLogger(const std::string& l_out_file,
